...
var instrucciones = ["Utilizá las flechas del teclado para mover las piezas.", "Realizá los movimientos necesarios para formar la imagen de abajo."];
...
function chequearSiGano() {
  ...
  for (var i = 0; i < grilla.length; i++) {
    for (var j = 0; j < grilla[i].length; j++) {
      ...
      /*si el if se cumple, sale de la función, sino la continúa*/
      token++;
    }
  }
  return true;
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    var posTemp = grilla[filaPos1][columnaPos1];
    grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
    grilla[filaPos2][columnaPos2] = posTemp;
}
